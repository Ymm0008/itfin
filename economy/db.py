...
def getDetectRank(table1,table2,table3,date,field):
	...
	sql1 = 'select entity_id,entity_name,count(*),sum(risk_level) from %s where date>"%s" and date<="%s" and illegal_type>0 and risk_level>0 group by entity_id order by count(*) desc,sum(risk_level) desc'%(table1,start_time,end_time)
	cur.execute(sql1)
	res1 = cur.fetchall()
	sql2 = 'select entity_id,entity_name,count(*),sum(risk_level) from %s where date>"%s" and date<="%s" and illegal_type>0 and risk_level>0 group by entity_id order by count(*) desc,sum(risk_level) desc'%(table2,start_time,end_time)
	cur.execute(sql2)
	res2 = cur.fetchall()
	sql3 = 'select entity_id,entity_name,count(*),sum(risk_level) from %s where date>"%s" and date<="%s" and illegal_type>0 and risk_level>0 group by entity_id order by count(*) desc,sum(risk_level) desc'%(table3,start_time,end_time)
	cur.execute(sql3)
	res3 = cur.fetchall()
	res = res1 + res2 + res3
	result = [{k:row[i] for i,k in enumerate(field)} for row in res]
...
def getDetectDistribute(date,table1,table2,table3,table4,field):
	...
	province_list = []
	list = []
	sql1 = 'select pd.illegal_type,gs.province,gs.city,count(*) from %s as pd inner join %s as gs on pd.entity_id=gs.entity_id where pd.date>"%s" and pd.date<="%s" and illegal_type=1 and risk_level>0 group by province,city'%(table1,table4,start_time,end_time)
	sql11 = 'select pd.illegal_type,gs.province,gs.city,count(*) from %s as pd inner join %s as gs on pd.entity_id=gs.entity_id where pd.date>"%s" and pd.date<="%s" and illegal_type=1 and risk_level>0 group by province,city'%(table2,table4,start_time,end_time)
	sql12 = 'select pd.illegal_type,gs.province,gs.city,count(*) from %s as pd inner join %s as gs on pd.entity_id=gs.entity_id where pd.date>"%s" and pd.date<="%s" and illegal_type=1 and risk_level>0 group by province,city'%(table3,table4,start_time,end_time)
	sql2 = 'select pd.illegal_type,gs.province,gs.city,count(*) from %s as pd inner join %s as gs on pd.entity_id=gs.entity_id where pd.date>"%s" and pd.date<="%s" and illegal_type=2 and risk_level>0 group by province,city'%(table1,table4,start_time,end_time)
	sql21 = 'select pd.illegal_type,gs.province,gs.city,count(*) from %s as pd inner join %s as gs on pd.entity_id=gs.entity_id where pd.date>"%s" and pd.date<="%s" and illegal_type=2 and risk_level>0 group by province,city'%(table2,table4,start_time,end_time)
	sql22 = 'select pd.illegal_type,gs.province,gs.city,count(*) from %s as pd inner join %s as gs on pd.entity_id=gs.entity_id where pd.date>"%s" and pd.date<="%s" and illegal_type=2 and risk_level>0 group by province,city'%(table3,table4,start_time,end_time)
	sql3 = 'select pd.illegal_type,gs.province,gs.city,count(*) from %s as pd inner join %s as gs on pd.entity_id=gs.entity_id where pd.date>"%s" and pd.date<="%s" and illegal_type=3 and risk_level>0 group by province,city'%(table1,table4,start_time,end_time)
	sql31 = 'select pd.illegal_type,gs.province,gs.city,count(*) from %s as pd inner join %s as gs on pd.entity_id=gs.entity_id where pd.date>"%s" and pd.date<="%s" and illegal_type=3 and risk_level>0 group by province,city'%(table2,table4,start_time,end_time)
	sql32 = 'select pd.illegal_type,gs.province,gs.city,count(*) from %s as pd inner join %s as gs on pd.entity_id=gs.entity_id where pd.date>"%s" and pd.date<="%s" and illegal_type=3 and risk_level>0 group by province,city'%(table3,table4,start_time,end_time)
...
def getWarnCount(table1,table2,table3):
	...
	sql01 = "select count(*) from %s where illegal_type>0 and risk_level>0 and date>'%s' and date<='%s'"%(table1,start_time0,end_time)
	sql02 = "select count(*) from %s where illegal_type>0 and risk_level>0 and date>'%s' and date<='%s'"%(table1,start_time1,end_time)
	sql03 = "select count(*) from %s where illegal_type>0 and risk_level>0 and date>'%s' and date<='%s'"%(table1,start_time2,end_time)

	sql11 = "select count(*) from %s where illegal_type>0 and risk_level>0 and date>'%s' and date<='%s'"%(table2,start_time0,end_time)
	sql12 = "select count(*) from %s where illegal_type>0 and risk_level>0 and date>'%s' and date<='%s'"%(table2,start_time1,end_time)
	sql13 = "select count(*) from %s where illegal_type>0 and risk_level>0 and date>'%s' and date<='%s'"%(table2,start_time2,end_time)

	sql21 = "select count(*) from %s where illegal_type>0 and risk_level>0 and date>'%s' and date<='%s'"%(table3,start_time0,end_time)
	sql22 = "select count(*) from %s where illegal_type>0 and risk_level>0 and date>'%s' and date<='%s'"%(table3,start_time1,end_time)
	sql23 = "select count(*) from %s where illegal_type>0 and risk_level>0 and date>'%s' and date<='%s'"%(table3,start_time2,end_time)
...
def h_getWarnCount(table1,table2,table3):
	...
	sql1 = 'select count(*) from %s where illegal_type>0 and risk_level>0 and date>"%s" and date<="%s"'%(table1,start_time,end_time)	
	print(sql1)
	cur.execute(sql1)
	res1 = cur.fetchall()
	
	sql2 = 'select count(*) from %s where illegal_type>0 and risk_level>0 and date>"%s" and date<="%s"'%(table2,start_time,end_time)	
	cur.execute(sql2)
	res2 = cur.fetchall()
	
	sql3 = 'select count(*) from %s where illegal_type>0 and risk_level>0 and date>"%s" and date<="%s"'%(table3,start_time,end_time)
	cur.execute(sql3)
	res3 = cur.fetchall()
...
def get_city_rank(table1,table2,table3,table4,field,province_name):
	...
	sql1 = 'select pd.illegal_type,gs.province,gs.city,count(*) from %s as pd inner join %s as gs on pd.entity_id=gs.entity_id where pd.date>"%s" and pd.date<="%s" and illegal_type>0 and risk_level>0 group by province,city'%(table1,table4,start_time,end_time)
	cur.execute(sql1)
	res1 = cur.fetchall()
	result1 = [{k:row[i] for i,k in enumerate(field)} for row in res1]
	sql2 = 'select pd.illegal_type,gs.province,gs.city,count(*) from %s as pd inner join %s as gs on pd.entity_id=gs.entity_id where pd.date>"%s" and pd.date<="%s" and illegal_type>0 and risk_level>0 group by province,city'%(table2,table4,start_time,end_time)
	cur.execute(sql2)
	res2 = cur.fetchall()
	result2 = [{k:row[i] for i,k in enumerate(field)} for row in res2]
	sql3 = 'select pd.illegal_type,gs.province,gs.city,count(*) from %s as pd inner join %s as gs on pd.entity_id=gs.entity_id where pd.date>"%s" and pd.date<="%s" and illegal_type>0 and risk_level>0 group by province,city'%(table3,table4,start_time,end_time)
	cur.execute(sql3)
	res3 = cur.fetchall()
	result3 = [{k:row[i] for i,k in enumerate(field)} for row in res3]
	result = result1 + result2 + result3

	sql11 = 'select pd.illegal_type,gs.province,gs.city,count(*) from %s as pd inner join %s as gs on pd.entity_id=gs.entity_id where pd.date>"%s" and pd.date<="%s" and illegal_type>0 and risk_level>0 group by province,city'%(table1,table4,start_time1,end_time)
	cur.execute(sql11)
	res11 = cur.fetchall()
	result11 = [{k:row[i] for i,k in enumerate(field)} for row in res11]
	sql22 = 'select pd.illegal_type,gs.province,gs.city,count(*) from %s as pd inner join %s as gs on pd.entity_id=gs.entity_id where pd.date>"%s" and pd.date<="%s" and illegal_type>0 and risk_level>0 group by province,city'%(table2,table4,start_time1,end_time)
	cur.execute(sql22)
	res22 = cur.fetchall()
	result22 = [{k:row[i] for i,k in enumerate(field)} for row in res22]
	sql33 = 'select pd.illegal_type,gs.province,gs.city,count(*) from %s as pd inner join %s as gs on pd.entity_id=gs.entity_id where pd.date>"%s" and pd.date<="%s" and illegal_type>0 and risk_level>0 group by province,city'%(table3,table4,start_time1,end_time)
	cur.execute(sql33)
	res33 = cur.fetchall()
...
def get_province_rank(table1,table2,table3,table4,field):
	...
	sql1 = 'select gs.province,count(*) from %s as pd inner join %s as gs on pd.entity_id=gs.entity_id where pd.date>"%s" and pd.date<="%s" and illegal_type>0 and risk_level>0 group by province'%(table1,table4,start_time0,end_time)
	cur.execute(sql1)
	res1 = cur.fetchall()
	result1 = [{k:row[i] for i,k in enumerate(field)} for row in res1]
	sql2 = 'select gs.province,count(*) from %s as pd inner join %s as gs on pd.entity_id=gs.entity_id where pd.date>"%s" and pd.date<="%s" and illegal_type>0 and risk_level>0 group by province'%(table2,table4,start_time0,end_time)
	cur.execute(sql2)
	res2 = cur.fetchall()
	result2 = [{k:row[i] for i,k in enumerate(field)} for row in res2]
	sql3 = 'select gs.province,count(*) from %s as pd inner join %s as gs on pd.entity_id=gs.entity_id where pd.date>"%s" and pd.date<="%s" and illegal_type>0 and risk_level>0 group by province'%(table3,table4,start_time0,end_time)
	cur.execute(sql3)
	res3 = cur.fetchall()
	result3 = [{k:row[i] for i,k in enumerate(field)} for row in res3]
	
	sql4 = 'select gs.province,count(*) from %s as pd inner join %s as gs on pd.entity_id=gs.entity_id where pd.date>"%s" and pd.date<="%s" and illegal_type>0 and risk_level>0 group by province'%(table1,table4,start_time1,end_time)
	cur.execute(sql4)
	res4 = cur.fetchall()
	result4 = [{k:row[i] for i,k in enumerate(field)} for row in res4]
	sql5 = 'select gs.province,count(*) from %s as pd inner join %s as gs on pd.entity_id=gs.entity_id where pd.date>"%s" and pd.date<="%s" and illegal_type>0 and risk_level>0 group by province'%(table2,table4,start_time1,end_time)
	cur.execute(sql5)
	res5 = cur.fetchall()
	result5 = [{k:row[i] for i,k in enumerate(field)} for row in res5]
	sql6 = 'select gs.province,count(*) from %s as pd inner join %s as gs on pd.entity_id=gs.entity_id where pd.date>"%s" and pd.date<="%s" and illegal_type>0 and risk_level>0 group by province'%(table3,table4,start_time1,end_time)
	cur.execute(sql6)
	res6 = cur.fetchall()
	result6 = [{k:row[i] for i,k in enumerate(field)} for row in res6]
...
def getTimeDistribute(table1,table2,table3):
	...
	for i,time in enumerate(time_list):
		...
		sql1 = "select count(*) from %s where date='%s' and illegal_type>0 and risk_level>0"%(table1,time)
		print(sql1)
		cur.execute(sql1)
		res1 = cur.fetchall()[0][0]

		sql2 = "select count(*) from %s where date='%s' and illegal_type>0 and risk_level>0"%(table2,time)
		cur.execute(sql2)
		res2 = cur.fetchall()[0][0]
	
		sql3 = "select count(*) from %s where date='%s' and illegal_type>0 and risk_level>0"%(table3,time)
		cur.execute(sql3)
		res3 = cur.fetchall()[0][0]
